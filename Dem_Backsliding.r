...
dat.estonia$Vote.Choice <- recode_factor(dat.estonia$Q13,
                                         ...
                                         `Eesti Keskerakond` = "Centre Party",
                                         `Eesti Konservatiivne Rahvaerakond` = "Conservative People\'s Party",
...
save(conjoint.d.chile, file="/Users/hectorbahamonde/research/democratic_backsliding/Replication_Materials/dat_chile.RData")
save(conjoint.d.estonia, file="/Users/hectorbahamonde/research/democratic_backsliding/Replication_Materials/dat_estonia.RData")
...
p_load(ggplot2)
amce_Winner_Loser.p = ggplot(amce_Winner_Loser.d,
                             aes(factor(level),
                                 y=estimate,
                                 ymin=lower,
                                 ymax=upper,
...
ggsave(amce_Winner_Loser.p, file="Conjoint_Winner_Loser_AMCE.pdf", width=12, height=10)
