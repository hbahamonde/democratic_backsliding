...
\begin{columns}[T] % The [T] option aligns column content at the top
    ...
    \begin{column}{0.5\textwidth} % Left column and width
        \begin{itemize}
            ...
            \item<4-> Still, we know little about the losing side's commitment to democracy among \emph{voters}.
        \end{itemize}
    \end{column}
...
\framesubtitle{\& Institutional Heterogeneities}
  ...
  \begin{itemize}
    \item We analyze the level of system support among electoral ``losers'' using data from a novel conjoint experiment.

    \item We exploit institutional heterogeneities in consensus and majoritarian democracies (Chile and Estonia), which effectively alter the costs for election ``losers'' and ``winners.''

    \item We pre-registered the following hypotheses: \href{https://osf.io/u72z4}{\beamergotobutton{\texttt{link}}} %\href{https://osf.io/u72z4}{\beamerbutton{pre-registered}}
      
    \begin{itemize}
      \item Election ``losers'' favor candidates endorsing anti-systemic actions more than ``winners.''
      \item This tendency is stronger in presidential versus parliamentary systems.
    \end{itemize}
...
\framesubtitle{\& Institutional Heterogeneities}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item {\color{americanrose}Election ``losers'' favor candidates endorsing anti-systemic actions more than ``winners.''}
      \item This tendency is stronger in presidential versus parliamentary systems.
    \end{itemize}
...
\framesubtitle{\& Institutional Heterogeneities}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item Election ``losers'' favor candidates endorsing anti-systemic actions more than ``winners.''
      \item {\color{amber}This tendency is stronger in presidential versus parliamentary systems.}
    \end{itemize}
