...
\begin{columns}[T] % The [T] option aligns column content at the top
    ...
    \begin{column}{0.5\textwidth} % Left column and width
        \begin{itemize}
            ...
            \item<4-> Unfortunately, the ``losers' consent'' literature has not studied the propensity to support anti-systemic protests.
        \end{itemize}
    \end{column}
...
\begin{column}[T]{0.45\textwidth}
    ...
    \begin{itemize}
        ...
        \item {\bf Most similar cases} (two consolidated Third-wave democracies): minimize variance regarding critical V-Dem variables.
    \end{itemize} 
    \end{minipage}}
\end{column}
...
\begin{column}[T]{0.45\textwidth}
    \begin{minipage}[c][.6\textheight][c]{\linewidth}
    \begin{itemize}
        \item {\only<2>{\leavevmode\color{Red}}(Hypothetical) Candidates favoring anti-systemic protests are systematically {\bf supported} by (actual) losers.}
...
\begin{column}[T]{0.45\textwidth}
    \begin{minipage}[c][.6\textheight][c]{\linewidth}
    \begin{itemize}
        \item {\only<2>{\leavevmode\color{Red}}(Hypothetical) Candidates favoring anti-systemic protests are systematically {\bf rejected} by {\bf both} winners and losers.}
