...
\author[hb]{Hector Bahamonde \inst{1}}
\author[is]{Inga Saikkonen \inst{2}}
\author[mt]{Mart Trasberg \inst{3}}

\institute[hb]{\inst{1} University of Turku, Finland}
\institute[is]{\inst{2} \A Abo Akademi, Finland}
\institute[mt]{\inst{3} Monterrey Tec, Mexico}
